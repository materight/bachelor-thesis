...
A simple version of the ARIMA model can only be used to forecast non-seasonal time series. However, it can be extended to model seasonal patterns with the Seasonal ARIMA (SARIMA)~\cite{hyndman2018}. There are four additional seasonal parameters not part of ARIMA that must be configured:
\begin{itemize}
